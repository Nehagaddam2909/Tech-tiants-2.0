        ...
        <div className="flex h-screen">
            ...
            <div className="flex items-center justify-center w-1/2 bg-white">
                <div className="w-3/4 px-8 py-6 space-y-10">
                    <h2 className="text-4xl   text-blue-500 text-center font-bold mb-4">Signup</h2>
                    ...
                    <div className="flex justify-between">
                        ...
                        <Link to='/Teacher/Login/' className="bg-white text-blue-500 py-2 px-4 rounded">Login</Link>
                    </div>
                </div>
            </div>
            {/* Rigjt Section */}
            <div className="flex items-center justify-center w-1/2 bg-blue-500">
                <div className="text-white text-center">
                    ...
                    <div className="mt-8 space-x-3 ">
                        ...
                        <a href="#" className="text-white">Login Here</a>
                    </div>
                </div>
            </div>
